...
export const SubmitSolution: React.FC = () => {
  ...
  if (submitted) {
    return (
      <div className="min-h-[80vh] py-20 bg-black flex items-center justify-center">
        <div className="max-w-md w-full mx-auto px-6 text-center animate-fade-in-up">
          ...
          <h2 className="text-3xl font-display font-bold text-white mb-3">Problem Submitted!</h2>
  ...
  return (
    <div className="min-h-[80vh] py-20 bg-black flex items-center justify-center relative">
      <PaywallModal
      ...
      <div className="max-w-3xl w-full mx-auto px-6 relative z-10">
        ...
        <Card variant="elevated" padding="xl" className="!bg-zinc-900 !border-zinc-800">
          <div className="max-w-xl mx-auto">
            <div className="text-center mb-10">
              <h1 className="text-4xl font-display font-bold mb-4 text-white">Submit Your Problem</h1>
            ...
            <form onSubmit={handleFormSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-4 py-3 focus:outline-none focus:border-brand-primary focus:ring-1 focus:ring-brand-primary transition-all text-white placeholder:text-zinc-600"
              ...
              <div>
                <label className="block text-sm font-medium mb-2 text-zinc-300">Problem Description</label>
                <textarea
                  name="problem"
                  required
                  rows={5}
                  ...
                  onChange={handleFormChange}
                  className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-4 py-3 focus:outline-none focus:border-brand-primary focus:ring-1 focus:ring-brand-primary transition-all text-white resize-none placeholder:text-zinc-600"
