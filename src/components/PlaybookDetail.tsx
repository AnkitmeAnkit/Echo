...
export const PlaybookDetail: React.FC = () => {
    ...
    return (
      <div className="py-24 text-center max-w-sm mx-auto px-6">
        ...
        <button 
          ...
          className="text-zinc-400 hover:text-white font-semibold text-sm cursor-pointer transition-colors"
        >
          Return to Playbooks
        </button>
      </div>
  ...
  return (
    <div className="bg-black min-h-screen font-sans pb-24 relative">
      ...
      <section className="max-w-[1860px] mx-auto px-6 pt-12 pb-8">
        <button 
          onClick={() => navigate('/playbooks')}
          className="text-zinc-500 hover:text-white flex items-center space-x-2 transition-colors cursor-pointer text-sm font-semibold mb-8"
        >
      ...
      <section className="max-w-[1860px] mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-4 space-y-6 animate-fade-in-up">
            <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6 flex items-center justify-center shadow-sm">
              <div className="w-full aspect-[4/5] rounded-md overflow-hidden bg-zinc-950 relative shadow-sm">
                <img 
            ...
            <div className="border border-zinc-800 p-8 space-y-6 bg-zinc-900 rounded-lg shadow-sm">
              ...
              <div className="space-y-4">
                ...
                {hasPurchased ? (
                  <button
                    ...
                    className="w-full bg-brand-primary text-white hover:bg-brand-primary/90 py-3 text-center rounded-md font-semibold text-sm transition-colors cursor-pointer flex items-center justify-center gap-2 disabled:opacity-70"
                  >
                  ...
                  <button
                    ...
                    className="w-full bg-brand-primary text-white hover:bg-brand-primary/90 py-3 text-center rounded-md font-semibold text-sm transition-colors cursor-pointer flex items-center justify-center gap-2 min-h-[44px]"
                  >
          ...
          <div className="lg:col-span-8 space-y-12 animate-fade-in-up" style={{ animationDelay: '150ms' }}>
            <div className="space-y-4">
              ...
              <h1 className="font-display text-4xl md:text-5xl text-white font-semibold tracking-tight">
                {playbook.title}
              </h1>
              <p className="text-lg text-zinc-400 font-medium pt-2">
                {playbook.subtitle}
              </p>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-3 pb-2 border-b border-zinc-800">
                <h2 className="font-display text-2xl text-white font-semibold tracking-tight">
                  Table of Contents
                </h2>
                <span className="bg-zinc-900 border border-zinc-800 px-2 py-1 rounded-md text-xs font-semibold text-zinc-400">
              ...
              <div className="space-y-4">
                {playbook.chapters?.map((chapter, index) => {
                  ...
                  return (
                    <div 
                      key={chapter.id}
                      className={`border border-zinc-800 p-6 bg-zinc-900 rounded-lg transition-colors ${isChapterBlurred ? 'cursor-pointer hover:border-brand-primary/50' : ''}`}
                    ...
                    >
                      <div className="flex justify-between items-start mb-4">
                        ...
                        {!isChapterBlurred ? (
                          <span className="text-xs font-medium bg-zinc-950 border border-zinc-800 text-zinc-400 px-2 py-1 rounded-md">
                            Preview available
                          </span>
                        ) : (
                          <span className="text-xs font-medium bg-zinc-950 border border-zinc-800 text-zinc-400 px-2 py-1 rounded-md">
                      ...
                      <div className="relative">
                        <div className={`prose prose-sm max-w-none text-zinc-400 leading-relaxed ${isChapterBlurred ? 'blur-sm select-none pointer-events-none opacity-40' : ''}`}>
