  ...
  return (
    <div className="w-full bg-black min-h-screen pb-32">
      <div className="max-w-[1860px] mx-auto px-6 pt-12">
        <button onClick={() => navigate("/solutions")} className="flex items-center gap-2 text-zinc-500 hover:text-white transition-colors mb-8 text-sm font-medium">
          <ArrowLeft className="w-4 h-4" /> Back to Solutions
        </button>

        <div className="flex items-center justify-between mb-10">
          <div>
            <h1 className="text-4xl font-display font-bold text-white">All Problems</h1>
            <p className="text-zinc-400 mt-2">Browse all {PREDEFINED_PROBLEMS.length} predefined consulting problems. Click one to get started.</p>
          </div>
        </div>
