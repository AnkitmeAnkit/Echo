      ...
      <div className="max-w-[1860px] mx-auto px-6 pt-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 animate-fade-in-up">
          <div className="lg:col-span-4 flex flex-col justify-center">
            <h1 className="text-4xl md:text-5xl font-display font-bold mb-4 text-text-primary dark:text-white">Playbooks</h1>
            <p className="text-text-secondary dark:text-zinc-400 mb-8 leading-relaxed">
          ...
          <div className="lg:col-span-8 bg-canvas-white dark:bg-zinc-900 border border-border-light dark:border-zinc-800 rounded-[2rem] p-10 flex flex-col md:flex-row items-center gap-8 overflow-hidden relative">
            <div className="relative z-10 flex-1">
              <h2 className="text-2xl font-bold mb-4 text-text-primary dark:text-white">Enable AI in your work the right way</h2>
              <p className="text-text-secondary dark:text-zinc-400 mb-8">Access well-researched guides, practical instructions, and free resources to get the most out of AI.</p>
              <div className="flex flex-wrap gap-3">
                {metadataTags.map((tag, i) => (
                  <div key={i} className="flex items-center gap-2 bg-canvas dark:bg-zinc-950 border border-border-light dark:border-zinc-800 px-3 py-1.5 rounded-lg text-sm text-text-secondary dark:text-zinc-300 font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          <Card padding="xl" className="flex items-center gap-8 relative overflow-hidden group hover:shadow-card cursor-pointer !bg-canvas-white dark:!bg-zinc-900 !border-border-light dark:!border-zinc-800">
            ...
            <div className="relative z-10">
              <h3 className="text-2xl font-bold mb-2 text-text-primary dark:text-white">Task-Specific Playbooks</h3>
              <p className="text-text-secondary dark:text-zinc-400 mb-6">Step-by-step guides for specific tasks to help you work smarter and faster with AI.</p>
          ...
          <Card padding="xl" className="flex items-center gap-8 relative overflow-hidden group hover:shadow-card cursor-pointer !bg-canvas-white dark:!bg-zinc-900 !border-border-light dark:!border-zinc-800">
            ...
            <div className="relative z-10">
              <h3 className="text-2xl font-bold mb-2 text-text-primary dark:text-white">Industry-Specific Playbooks</h3>
              <p className="text-text-secondary dark:text-zinc-400 mb-6">Domain-focused playbooks tailored for your industry's unique challenges.</p>
        ...
        <div className="mb-20 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          <h2 className="text-2xl font-display font-bold mb-8 text-text-primary dark:text-white">What You'll Get</h2>
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            {whatYouGet.map((item, i) => (
              <div key={i} className="flex flex-col items-center text-center p-4">
                <div className="w-14 h-14 bg-canvas-white dark:bg-zinc-900 border border-border-light dark:border-zinc-800 rounded-2xl text-brand-primary flex items-center justify-center mb-4 relative">
                  {item.icon}
                  {item.badge && (
                ...
                <h4 className="font-bold text-sm mb-2 text-text-primary dark:text-white">{item.title}</h4>
        ...
        <div className="mb-12 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {filteredPlaybooks.map((playbook, i) => (
              <Card key={i} className="flex flex-col hover:border-brand-primary/30 transition-colors group cursor-pointer relative overflow-hidden !bg-canvas-white dark:!bg-zinc-900 !border-border-light dark:!border-zinc-800" onClick={() => navigate(`/playbooks/${playbook.slug}`)}>
                <div className="mb-4">
        ...
        {/* Bottom Lock Banner */}
        <Card variant="elevated" padding="md" className="flex flex-col sm:flex-row items-center justify-between gap-6 !bg-canvas-white dark:!bg-zinc-900 !border-border-light dark:!border-zinc-800 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          <div className="flex items-center gap-4">
             ...
             <p className="text-text-secondary dark:text-zinc-400 font-medium">
               {currentUser 
