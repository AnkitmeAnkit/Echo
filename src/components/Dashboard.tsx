...
import { 
  Home, BookOpen, Heart, Bell, Search, Filter, 
  Wand2, ArrowRight, Clock, CheckCircle2, AlertCircle, Loader2
} from 'lucide-react';
import { getPlaybookDownloadLink } from '../supabaseClient';

export function Dashboard() {
  const { currentUser, navigate, playbooks, purchasedSlugs, wishlistItems, toggleWishlist } = useAppState();
  const [activeTab, setActiveTab] = useState<'dashboard' | 'library' | 'wishlist'>('dashboard');
        ...
        <div className="p-4">
          <div className="bg-canvas-white dark:bg-zinc-900 border border-border-light dark:border-zinc-800 rounded-2xl p-6 text-center shadow-soft relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h4 className="font-bold text-sm mb-2 text-text-primary dark:text-white">Discover Playbooks</h4>
              <p className="text-xs text-text-secondary dark:text-zinc-400 mb-4 leading-relaxed">
                Explore expertly crafted playbooks to accelerate your work with AI.
              </p>
